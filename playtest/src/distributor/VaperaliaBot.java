...
import dto.CartResultDto;
import dto.ItemDto;
import dto.PriceOptionDto;
...
public class VaperaliaBot {
    ...
    public VaperaliaBot(String url, String username, String password, String sessionFilePath) {
        this.url = url;
    ...
    private List<CartItemDto> scrapeCart(Page page) {
        // TODO: navigate to cart page and scrape items after inspecting DOM
